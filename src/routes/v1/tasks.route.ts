 ...
 * tags:
 *   name: Tasks
 *   description: Scheduled tasks for Minecraft instances to fetch and execute
 */
 ...
 *     description: Schedule a remote task for one of the Decked Out 2 instances.
 *     tags: [Tasks]
 *     requestBody:
 *       required: true
 *       content:
 ...
 *     description: Retrieve tasks, typically filtered for a specific server for it to action.
 *     tags: [Tasks]
 *     parameters:
 *       - in: query
 *         name: server
 ...
 *     description: Update a task's state to  one of [ "SCHEDULED", "IN_PROGRESS", "SUCCEEDED", "FAILED" ]
 *     tags: [Tasks]
 *     parameters:
 *       - in: path
 *         name: id
